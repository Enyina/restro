...
const Page=()=>{
  ...
  const closeModal = () => setIsModalOpen(false);
    return (
        ...
        <div className={` absolute w-[89%] h-12   bottom-2 inset-x-1  mx-auto   `}>
        ...
        <div className={`${isModalOpen? " absolute top-0 z-50  translate-y-0 block ": " translate-y-full hidden"} w-full  transition duration-500 ease-in-out`}>  <ItemDetail onClose={closeModal} /> </div>
        {isAdded && (
